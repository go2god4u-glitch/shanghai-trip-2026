const CACHE='shanghai-trip-v26';
const ASSETS=['./','./index.html','./styles.css','./app.js','./food-extras.js','./vendor/leaflet.css','./vendor/leaflet.js','./manifest.webmanifest','./icon.svg'];
