const places = [
  ...
  {name:'晟永兴（外滩店）',ko:'성용싱 · 예약 전 선택지',address:'上海市黄浦区广东路20号外滩5号5楼东侧',tag:'일정 밖 선택지'},
...
const foodDetails = {
  ...
  '2026-09-24T19:00:00+08:00':{
    ...
    intro:'베이징덕 전문점의 와이탄 북쪽 지점입니다. 난징동루 산책 뒤 이동하고 식후 와이탄 야경으로 돌아옵니다.', booking:'9월 24일(목) 19:00, 2명 자리와 베이징덕 제공 여부를 식당에 확인해야 합니다. 호텔에는 외부 식당 예약 문의를 대신할 수 있는지 먼저 물어보세요. 호텔의 예약 대행 가능 여부는 확인되지 않았습니다. 인기점이라 대기 가능성이 있으며, 예약 완료 전에는 확정 일정이 아닙니다.',
