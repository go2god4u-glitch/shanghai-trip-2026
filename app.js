...
const foodDetails = {
  ...
  '2026-09-24T12:00:00+08:00':{
    ...
    intro:'고급스러운 공간과 안정적인 서비스가 강점인 광둥식 파인다이닝입니다. 예약을 유지한다면 딤섬 6~7접시를 골고루 먹고 이후 게살국수를 위해 여유를 남깁니다.', booking:'예약 성공 · 2026년 9월 24일(목) 12:00 · 2명 · Yifeng Galleria. 11:40까지 도착해 예약자 이름과 예약 번호가 담긴 원본 확인 화면을 제시하세요. 예약 번호·성명은 공개 웹페이지에 게시하지 않았습니다.',
  ...
  '2026-09-24T15:15:00+08:00':{
    ...
    intro:'딤섬 점심과 베이징덕 저녁 사이에 상하이 게살면을 맛보는 곳입니다. 독립된 한 끼가 아니라 두 사람이 1그릇만 공유하는 것이 일정의 핵심입니다.', booking:'별도 예약 일정 없음. 15:15 전후 현장 대기를 확인하고, 저녁 19:00 성용싱 예약을 방해할 정도로 길면 생략하세요.',
