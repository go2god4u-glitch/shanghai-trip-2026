const places = [
  ...
  {name:'燕云楼（广西北路店）',ko:'옌윈러우 · 2일차 베이징덕 후보',address:'上海市黄浦区广西北路288号8-9楼',tag:'저녁 후보'},
...
const nameReadings = [
  ...
  ['庄氏隆兴面馆','좡스 룽싱 몐관'],['燕云楼','옌윈러우'],['晟永兴','성융싱'],
...
const scheduleMaps = {
  ...
  '2026-09-24T19:00:00+08:00':['燕云楼 广西北路288号','옌윈러우 · 베이징덕 저녁 후보'],
...
const foodDetails = {
  ...
  '2026-09-24T19:00:00+08:00':{
    name:'옌윈러우 난징동루점 (燕云楼)', badge:'2일차 저녁 후보 · 아직 예약하지 않음', address:'광시베이루 288호 8–9층 (广西北路288号8-9楼)', budget:'가격은 예약·현장 메뉴 기준',
    intro:'난징동루 부근의 오래된 베이징 요리 식당입니다. 베이징덕이 대표 메뉴라 성용싱 대신 2일차 저녁 후보로 넣었습니다.', booking:'9월 24일(목) 19:00, 2명 자리와 베이징덕 제공 여부를 호텔 컨시어지에 확인해 달라고 부탁하세요. 현재 영업시간과 예약 가능 여부는 아직 확인되지 않았으며, 예약 완료 전에는 확정 일정이 아닙니다. 성용싱은 일정 밖 선택지로 장소 목록에만 남겼습니다.',
...
const dayRoutes = [
  ...
  {title:'2일차 전체 동선',note:'호텔 → 다후춘 → 와이탄위안·예약 식당 → 와이탄·난징동루',stops:[['大壶春','다후춘 아침','大壶春 四川中路店','도보 또는 짧은 DiDi'],['外滩源','와이탄위안 아침 산책','外滩源','도보 · 11:40 도착 권장'],['御宝轩','Imperial Treasure','御宝轩 益丰外滩源店','도보'],['外滩','와이탄 강변','外滩','도보 또는 짧은 DiDi'],['庄氏隆兴面馆','장씨네 게살국수','庄氏隆兴面馆 浙江中路店','도보'],['南京东路','난징동루','南京东路步行街','도보'],['燕云楼','옌윈러우 · 베이징덕','燕云楼 广西北路288号','도보 또는 짧은 DiDi'],['外滩·外滩源','와이탄 야경·빛축제','外滩','DiDi → 호텔']]},
...
const dayMapPoints = [
  ...
  [[121.4847725,31.2367029,'wgs'],[121.4841599,31.2443887,'wgs'],[121.488895,31.240436,'gcj'],[121.4876320,31.2353356,'wgs'],[121.4729059,31.2387686,'wgs'],[121.4792191,31.2391470,'wgs'],[121.477196,31.235136,'gcj'],[121.4876320,31.2353356,'wgs']],
